...
<CENTER>
      <font face="Arial, Helvetica, sans-serif" color="#3333CC" size=6><b><u>Ranks</u></b></font><br><br>
    ...
    function Scorecard(&$conn)
    {
       ...
       $result = mysqli_query($conn,"SELECT * FROM `stud_data`");
        if ($result->num_rows>0) 
        {
         ...
         <thead style="background-color:rgb(55,58,190)"><td style="border:2px solid black;color:white">STUDENT ID</td><td style="border:2px solid black;color:white">STUDENT NAME</td><td style="border:2px solid black;color:white">PHYSICS RANK</td><td style="border:2px solid black;color:white">MATHEMATICS RANK</td><td style="border:2px solid black;color:white">CHEMISTRY RANK</td><td style="border:2px solid black;color:white">ENGLISH RANK</td><td style="border:2px solid black;color:white">COMPUTER RANK</td></thead>
         ...
         {
             ?>
          <tr><td style="border:2px solid black;"><?php echo $ID; ?></td><td style="border:2px solid black;"><?php echo $Name;?></td><td style="border:2px solid black;"><?php echo $PhyRank;?></td><td style="border:2px solid black;"><?php echo $MathRank;?></td><td style="border:2px solid black;"><?php echo $ChemRank;?></td><td style="border:2px solid black;"><?php echo $EngRank;?></td><td style="border:2px solid black;"><?php echo $CompRank;?></td></tr>
      ...
      <?php
        ...
        ?>
            <tr bgcolor="aliceblue"><td style="border:2px solid black;"><?php echo $ID; ?></td><td style="border:2px solid black;"><?php echo $Name;?></td><td style="border:2px solid black;"><?php echo $PhyRank;?></td><td style="border:2px solid black;"><?php echo $MathRank;?></td><td style="border:2px solid black;"><?php echo $ChemRank;?></td><td style="border:2px solid black;"><?php echo $EngRank;?></td><td style="border:2px solid black;"><?php echo $CompRank;?></td></tr>
