...
<CENTER>
      <font face="Arial, Helvetica, sans-serif" color="#3333CC" size=6><b><u>Grades</u></b></font><br><br>
       ...
       $result = mysqli_query($conn,"SELECT * FROM `stud_data`");
        if ($result->num_rows>0) 
        {
         ...
         thead {color:white;}
          ...
          <thead style="background-color:rgb(55,58,190)"><td style="border:2px solid black;color:white">STUDENT ID</td><td style="border:2px solid black;color:white">STUDENT NAME</td><td style="border:2px solid black;color:white">PHYSICS GRADE</td><td style="border:2px solid black;color:white">MATHEMATICS GRADE</td><td style="border:2px solid black;color:white">CHEMISTRY GRADE</td><td style="border:2px solid black;color:white">ENGLISH GRADE</td><td style="border:2px solid black;color:white">COMPUTER GRADE</td></thead>
         ...
         {
             ?>
    <tr><td style="border:2px solid black;"><?php echo $ID; ?></td><td style="border:2px solid black;"><?php echo $Name;?><td style="border:2px solid black;"><?php echo $PhyGrd;?></td><td style="border:2px solid black;"><?php echo $MathGrd;?></td><td style="border:2px solid black;"><?php echo $ChemGrd;?></td><td style="border:2px solid black;"><?php echo $EngGrd;?></td><td style="border:2px solid black;"><?php echo $CompGrd;?></td>
      ...
      <?php
        ...
        ?>
            <tr bgcolor="aliceblue"><td style="border:2px solid black;"><?php echo $ID; ?></td><td style="border:2px solid black;"><?php echo $Name;?><td style="border:2px solid black;"><?php echo $PhyGrd;?></td><td style="border:2px solid black;"><?php echo $MathGrd;?></td><td style="border:2px solid black;"><?php echo $ChemGrd;?></td><td style="border:2px solid black;"><?php echo $EngGrd;?></td><td style="border:2px solid black;"><?php echo $CompGrd;?></td>
