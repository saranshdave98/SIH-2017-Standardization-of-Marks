...
<font face="Arial, Helvetica, sans-serif" color="#3333CC" size=2>(All Regions)</font>
    ...
    <form align="center" action="scorecard.php" method="post">

        <table width=35% align="center">
            <tr>
                <td align=left>
                    <FONT color=black face=Arial size=2><STRONG>Enter your Roll 
          Number:</STRONG></td><td width="64%">

      <input type="text" placeholder="Roll Number" name="rname" id="RollNo"  style="width: 114px" AUTOCOMPLETE = "off"></td></tr>
      <tr><td align=left><FONT color=black face=Arial size=2><STRONG>Enter your Mother's Name:</STRONG></td><td>

      <input type="password" placeholder="Mother's Name" name="mname" id="MotherName" style="width: 114px" AUTOCOMPLETE = "off"></td></tr>
      <tr>
        <td colspan=2 align=left><font color="#FF0000" size=2><b>(as given on your admit card)</b></font>
                </td>
            </tr>
            <tr align=center>
...
if(isset($_GET["login"]))
{
    if($_GET["login"]=="fail")
    {
        echo "<script>document.getElementById('alerttext').innerHTML='<br><b>Roll Number or Mother\'s Name is either empty or wrong!</b>';</script>";
    }
}
?>
 </div>
    ...
    <footer align="center">
        ...
        <br>
        <br>
        <FONT color=red face=Arial size=4><b>For Administrator Login:</b></FONT>
        <a href="AdminLogin.php"><FONT face=Arial size=4>Click Here</FONT></a>
        <br>
        <br>
        <br>
        <br>
