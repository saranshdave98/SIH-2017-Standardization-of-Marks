...
<CENTER>
      <font face="Arial, Helvetica, sans-serif" color="#3333CC" size=6><b><u>Marks</u></b></font><br><br>
    ...
    function Scorecard(&$conn)
    {
       ...
       $result = mysqli_query($conn,"SELECT * FROM `stud_data`");
        if ($result->num_rows>0) 
        {
         ...
         <thead style="background-color:rgb(55,58,190)"><td style="border:2px solid black;color:white">STUDENT ID</td><td style="border:2px solid black;color:white">STUDENT NAME</td><td style="border:2px solid black;color:white">PHYSICS</td><td style="border:2px solid black;color:white">MATHEMATICS</td><td style="border:2px solid black;color:white">CHEMISTRY</td><td style="border:2px solid black;color:white">ENGLISH</td><td>COMPUTER</td></thead>
         ...
         {
             ?>
    <tr><td style="border:2px solid black;"><?php echo $ID; ?></td><td style="border:2px solid black;"><?php echo $Name;?></td><td style="border:2px solid black;"><?php echo $PhyMark;?></td><td style="border:2px solid black;"><?php echo $MathMark;?></td><td style="border:2px solid black;"><?php echo $ChemMark;?></td><td style="border:2px solid black;"><?php echo $EngMark;?></td><td style="border:2px solid black;"><?php echo $CompMark;?></td></tr>
      ...
      <?php
        ...
        ?>
           <tr bgcolor="aliceblue"><td style="border:2px solid black;"><?php echo $ID; ?></td><td style="border:2px solid black;"><?php echo $Name;?></td><td style="border:2px solid black;"><?php echo $PhyMark;?></td><td style="border:2px solid black;"><?php echo $MathMark;?></td><td style="border:2px solid black;"><?php echo $ChemMark;?></td><td style="border:2px solid black;"><?php echo $EngMark;?></td><td style="border:2px solid black;"><?php echo $CompMark;?></td></tr>
