...
<form align="center" action="adminscorecard.php" method="post">
<table width=35% align="center">
            <tr>
                <td align=left>
                    <FONT color=black face=Arial size=2><STRONG>Enter The Roll 
...
if(isset($_GET["login"]))
{
    if($_GET["login"]=="fail")
    {
        echo "<script>document.getElementById('alerttext').innerHTML='<br><b>The entered Roll Number is Incorrect!</b>';</script>";
    }
}
?>
 </div>
