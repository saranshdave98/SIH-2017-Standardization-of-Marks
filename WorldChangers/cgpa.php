...
<CENTER>
    <font face="Arial, Helvetica, sans-serif" color="#3333CC" size=6><b><u>CGPA, Normalized Score, Merit Number</u></b></font><br><br>
    ...
    function Scorecard(&$conn)
    {
       ...
       $result = mysqli_query($conn,"SELECT * FROM `stud_data`");
        if ($result->num_rows>0) 
        {
         ...
         <thead style="background-color:rgb(55,58,190)"><td style="border:2px solid black;color:white">STUDENT ID</td><td style="border:2px solid black;color:white">STUDENT NAME</td><td style="border:2px solid black;color:white">CGPA</td><td style="border:2px solid black;color:white">NORMALIZED SCORE</td><td style="border:2px solid black;color:white">MERIT NO</td></thead>
         ...
         {
             ?>
    <tr><td style="border:2px solid black;"><?php echo $ID; ?></td><td style="border:2px solid black;"><?php echo $Name;?></td><td style="border:2px solid black;"><?php if($CGP>=3){echo $CGP;} else {echo "--";}?></td><td style="border:2px solid black;"><?php if($NORM!=0){echo round($NORM,4);} else {echo "--";}?></td><td style="border:2px solid black;"><?php if($MERIT_NO != 9999999){echo $MERIT_NO;} else {echo "--";}?></td></tr>
      ...
      <?php
        ...
        ?>
            <tr bgcolor="aliceblue"><td style="border:2px solid black;"><?php echo $ID; ?></td><td style="border:2px solid black;"><?php echo $Name;?></td><td style="border:2px solid black;"><?php if($CGP>=3){echo $CGP;} else {echo "--";}?></td><td style="border:2px solid black;"><?php if($NORM!=0){echo round($NORM,4);} else {echo "--";}?></td><td style="border:2px solid black;"><?php if($MERIT_NO != 9999999){echo $MERIT_NO;} else {echo "--";}?></td></tr>
